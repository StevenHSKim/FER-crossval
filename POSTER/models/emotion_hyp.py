...
class pyramid_trans_expr(nn.Module):
    def __init__(self, img_size=224, num_classes=7, type="large"):
        ...
        face_landback_checkpoint = torch.load('/userHome/userhome1/automl_undergraduate/FER_Models/FER_Models/POSTER/models/pretrain/mobilefacenet_model_best.pth.tar', map_location=lambda storage, loc: storage)
        ...
        ir_checkpoint = torch.load('/userHome/userhome1/automl_undergraduate/FER_Models/FER_Models/POSTER/models/pretrain/ir50.pth', map_location=lambda storage, loc: storage)
