...
def get_args():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='/userHome/userhome1/automl_undergraduate/FER_Models/FER_Models/LNSU-Net/checkpoints/ckplus', help='Checkpoint directory')
    ...
    for epoch in tqdm(range(start_epoch, args.epochs)):
        ...
        if val_acc > best_val_acc:
            ...
            best_checkpoint_path = os.path.join(
                args.checkpoint_dir, 
                f"ckplus_iter{iteration+1}_epoch{epoch}_acc{val_acc:.4f}_bacc{val_balanced_acc:.4f}.pth"
            )
...
def run_train_test():
    ...
    # Image and label paths for CKPlus
    image_path = "/userHome/userhome1/automl_undergraduate/FER_Models/datasets/CKPlus/ckplus_images"
    label_path = "/userHome/userhome1/automl_undergraduate/FER_Models/datasets/CKPlus/ckplus_labels.csv"
    ...
    for iteration in range(args.iterations):
        ...
        train_loader = DataLoader(
            CKPlusDataset(image_path, label_path, indices=train_indices),
        ...
        val_loader = DataLoader(
            CKPlusDataset(image_path, label_path, indices=val_indices),
            batch_size=args.batch_size,
            shuffle=False,
            num_workers=args.num_workers,
            pin_memory=True,
        ...
        test_loader = DataLoader(
            CKPlusDataset(image_path, label_path, indices=test_indices),
            batch_size=args.batch_size,
            shuffle=False,
    ...
    results_df.to_csv(os.path.join(args.checkpoint_dir, "LNSUNet_CKPlus_test_results.csv"), index=False)
