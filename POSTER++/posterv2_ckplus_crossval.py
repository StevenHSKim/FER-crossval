...
def parse_args():
    ...
    parser.add_argument('--data', type=str, default='/userHome/userhome1/timur/Haesung/datasets/CKPlus')
...
def run_train_test():
    ...
    checkpoint_dir = 'userHome/userhome1/timur/Haesung/POSTER++/checkpoint/ckplus'
    ...
    file_paths = [os.path.join(datapath, 'ckplus_images', fname) for fname in file_names]
