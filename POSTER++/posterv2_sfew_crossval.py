...
def parse_args():
    ...
    parser.add_argument('--data', type=str, default='/userHome/userhome3/timur/Haesung/datasets/SFEW2.0')
...
def run_train_test():
    ...
    checkpoint_dir = 'userHome/userhome3/timur/Haesung/POSTER++/checkpoint/sfew'
    ...
    file_paths = [os.path.join(datapath, 'sfew2.0_images', fname) for fname in file_names]
