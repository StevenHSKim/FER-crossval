...
def parse_args():
    ...
    parser.add_argument('--data', type=str, default='/userHome/userhome3/timur/Haesung/datasets/raf-basic')  # /userHome/userhome1/automl_undergraduate/FER_Models/datasets/raf-basic
...
def run_train_test():
    ...
    checkpoint_dir = '/userHome/userhome3/timur/Haesung/POSTER++/checkpoint/rafdb'
    ...
    datapath = '/userHome/userhome3/timur/Haesung/datasets/raf-basic'
    NAME_COLUMN = 0
    LABEL_COLUMN = 1
