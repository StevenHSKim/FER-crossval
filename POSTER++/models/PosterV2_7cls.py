...
class pyramid_trans_expr2(nn.Module):
    def __init__(self, img_size=112, num_classes=7, window_size=[28,14,7], num_heads=[2, 4, 8], dims=[64, 128, 256], embed_dim=768):
        super().__init__()
        ...
        face_landback_checkpoint = torch.load('/userHome/userhome3/timur/Haesung/POSTER++/models/pretrain/mobilefacenet_model_best.pth.tar',
        ...
        ir_checkpoint = torch.load('/userHome/userhome3/timur/Haesung/POSTER++/models/pretrain/ir50.pth', map_location=lambda storage, loc: storage)
...
def compute_param_flop():
    ...
    img = torch.rand(size=(1,3,112,112))
