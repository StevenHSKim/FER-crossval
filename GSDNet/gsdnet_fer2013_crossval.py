...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='/userHome/userhome3/timur/Haesung/datasets/FER2013/fer2013_modified.csv')
...
class FER2013Dataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = image.convert('RGB')  # Convert to RGB to match RAF-DB processing
